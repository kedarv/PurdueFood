@extends('user/layout')
@section('content')
<a href="{{ action('UserController@fbGoToLoginUrl')}}" class="btn btn-lg btn-facebook" style="width:230px;"><i class="fa fa-facebook btn-facebook-i"></i> Login with Facebook</a>
