...
$('#submit-comment').submit(function() {
	...
	$.ajax({
		...
		console.log(data);
			...
			$('.comments').prepend( "<div class='col-md-12'><div class='well'><img src='http://www.gravatar.com/avatar/" + data['email'] + "' alt='" + data['user'] + "' class='img-responsive' style='float:left;padding-right:10px;'/><h4 style='margin:0px 0px 0px 95px;'>" + data['user'] + "</h4><small>Posted at " + data['time'] +"</small><br/><br/><br/><hr/>" + data['comment'] + "</div></div>" )
		},
	});	
	return false;
});